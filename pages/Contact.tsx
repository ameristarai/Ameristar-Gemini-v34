            ...
            <div className="space-y-8">
              <div className="flex items-start gap-4 group">
                ...
                <div>
                  ...
                  <a href="mailto:shirleymiao888@gmail.com" className="text-gray-500 font-light hover:text-champagne transition-colors">
                    shirleymiao888@gmail.com
                  </a>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4 group">
                ...
                <div>
                  ...
                  <a href="tel:6263080150" className="text-gray-500 font-light hover:text-champagne transition-colors">
                    (626) 308-0150
                  </a>
                </div>
              </div>
            ...
            >
              ...
              <div>
                ...
                <input 
                  ...
                  className="w-full bg-transparent border-b border-gray-300 py-3 text-lg focus:outline-none focus:border-champagne transition-colors placeholder-gray-300"
              ...
              <div>
                ...
                <input 
                  ...
                  className={`w-full bg-transparent border-b py-3 text-lg focus:outline-none transition-colors placeholder-gray-300 ${
                    phoneError 
              ...
              <div>
                ...
                <textarea 
                  ...
                  rows={4}
                  className="w-full bg-transparent border-b border-gray-300 py-3 text-lg focus:outline-none focus:border-champagne transition-colors placeholder-gray-300 resize-none"
              ...
              <div className="pt-4">
                <button 
                  ...
                  className="w-full flex justify-center items-center gap-2 bg-obsidian text-paper py-4 rounded-xl hover:bg-gray-800 transition-all uppercase text-sm tracking-widest disabled:opacity-70 disabled:cursor-not-allowed"
                >
                  {isSubmitting ? (
