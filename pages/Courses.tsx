...
// --- DATA: Real Estate Courses (New Placeholder) ---
const realEstateCourses: CourseData[] = [
  {
    id: 're-principles',
    title: 'RE Principles',
    price: '$199',
    description: 'The foundational course required for all salespersons.',
    features: [
  ...
  },
  {
    ...
    title: 'RE Practice',
    price: '$199',
    description: 'Practical application of agency and fair housing laws.',
    features: [
      'Mandatory Licensing Course',
      'Real-world Forms Training',
      'Contract Analysis',
      'Case Studies',
      'Instructor Support'
    ]
  },
  {
    ...
    features: [
      'All 8 Statutory Courses',
      'Economics & Finance',
      'Property Management',
      'Advanced Legal Aspects',
        ...
        <div className="grid md:grid-cols-2 gap-12 max-w-5xl mx-auto">
          ...
          >
            ...
            <div className="absolute inset-0 z-20 flex flex-col items-center justify-center text-center p-8">
              ...
              <p className="text-white/90 font-light mb-8 max-w-xs drop-shadow-sm">
            ...
            <div 
              ...
              className={`relative p-8 md:p-10 rounded-3xl transition-all duration-500 group ease-out ${
                course.isPopular 
                  ...
                  : 'bg-paper border border-gray-200 shadow-sm hover:shadow-[0_40px_80px_-20px_rgba(0,0,0,0.15)] hover:bg-[#FFFAEB] hover:border-champagne/50'
              ...
              <ul className="space-y-4 mb-10">
                {course.features.map((feature, idx) => (
                  <li key={idx} className="flex items-center text-gray-600 font-light group-hover:text-gray-900 transition-colors">
                    <Check size={18} className="text-champagne mr-3 flex-shrink-0" />
                    <span>{feature}</span>
                  </li>
                ))}
              </ul>
