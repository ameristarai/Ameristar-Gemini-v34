        ...
        <aside className="hidden md:block md:col-span-3 lg:col-span-3">
          <div className="sticky top-32 space-y-8">
            ...
            <div className="bg-gray-50 p-6 rounded-xl border border-gray-100">
              ...
              <a href="mailto:shirleymiao888@gmail.com" className="text-sm font-serif text-obsidian hover:text-champagne transition-colors border-b border-gray-200 hover:border-champagne pb-0.5">
        ...
        <main className="md:col-span-9 lg:col-span-8 lg:col-start-5 space-y-16 animate-fade-in">
            ...
            <ul className="grid gap-3 text-gray-500 font-light">
              {[
                ...
                <li key={i} className="flex items-start gap-3">
                  <ChevronRight size={16} className="text-champagne mt-1 flex-shrink-0" />
                  <span>{item}</span>
                </li>
              ))}
            </ul>
          ...
          <section id="s10" className="scroll-mt-32">
            ...
            <div className="bg-champagne/10 p-6 rounded-xl">
              ...
              <a href="mailto:shirleymiao888@gmail.com" className="text-obsidian font-medium border-b border-black pb-0.5 hover:text-champagne hover:border-champagne transition-colors">
                shirleymiao888@gmail.com
              </a>
            </div>
          </section>
          ...
          <section id="s15" className="scroll-mt-32 pb-12">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              <div className="p-6 border border-gray-200 rounded-xl hover:border-champagne transition-colors group">
                ...
                <a href="mailto:shirleymiao888@gmail.com" className="text-sm text-gray-600 group-hover:text-obsidian break-all">
                  shirleymiao888@gmail.com
                </a>
              </div>
              <div className="p-6 border border-gray-200 rounded-xl hover:border-champagne transition-colors group">
