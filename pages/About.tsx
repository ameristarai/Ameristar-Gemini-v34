        ...
        <div className="grid md:grid-cols-12 gap-12 md:gap-24">
          ...
          <div className="md:col-span-7 flex flex-col justify-center space-y-8">
            ...
            <div className="space-y-6 text-gray-500 font-light text-lg leading-relaxed">
              ...
              <p>
                Having navigated the complexities of the California Department of Insurance exams herself, and later guiding countless professionals through the same rigorous process, Shirley identified a gap in the market. Existing resources were cluttered, archaic, and uninspiring.
              </p>
              <p>
                She believed that the educational journey should mirror the professionalism of the career itself—clean, direct, and distinguished.
              </p>
              <p>
                Today, her courses serve as the gold standard for aspiring agents in Life, Accident, and Health insurance. Whether you are taking your first step toward a license or seeking Continuing Education hours to maintain your standing, Shirley's curriculum is designed to respect your time and elevate your understanding.
              </p>
            </div>
